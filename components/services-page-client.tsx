...
const SERVICES = [
  ...
  {
    href: "/spark-plugs",
    eyebrowKey: "svc_spark_eyebrow",
    titleKey: "svc_spark_title",
    descKey: "svc_spark_desc",
    priceKey: "svc_spark_price",
    noPrice: true,
    icon: (
      <svg className="h-6 w-6" fill="none" stroke="currentColor" strokeWidth={1.75} viewBox="0 0 24 24">
  ...
  {
    href: "/fuel-filter",
    eyebrowKey: "svc_fuel_eyebrow",
    titleKey: "svc_fuel_title",
    descKey: "svc_fuel_desc",
    priceKey: "svc_fuel_price",
    noPrice: true,
    icon: (
      <svg className="h-6 w-6" fill="none" stroke="currentColor" strokeWidth={1.75} viewBox="0 0 24 24">
