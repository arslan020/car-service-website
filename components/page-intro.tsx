  ...
  return (
    <div className="border-b border-[color:var(--border)] bg-[linear-gradient(180deg,#fafdff_0%,#eef7ff_100%)]">
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 sm:py-14">
        {eyebrow && <p className="text-xs font-semibold uppercase tracking-[0.24em] text-[#0F63FF] sm:text-sm">{eyebrow}</p>}
        <h1 className="mt-2 text-2xl font-bold tracking-tight text-[#020F3D] sm:text-3xl lg:text-4xl">{title}</h1>
