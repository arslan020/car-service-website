      ...
      <div className="mx-auto flex max-w-7xl items-center justify-between gap-2 px-3 py-3 sm:gap-4 sm:px-4">
        ...
        <div className="flex items-center gap-2 xl:hidden">
          <a
            href={`tel:${site.phoneTel}`}
            aria-label="Call us"
            className="inline-flex h-11 w-11 items-center justify-center rounded-lg bg-[#020F3D] text-white transition hover:bg-[#0F63FF]"
          >
          ...
          <a
            ...
            rel="noopener noreferrer"
            aria-label="WhatsApp"
            className="inline-flex h-11 w-11 items-center justify-center rounded-lg bg-[#25D366] text-white transition hover:bg-[#20b958]"
          >
            ...
            <div>
              ...
              <div className="overflow-hidden rounded-2xl border border-[#edf2f8] bg-white shadow-sm divide-y divide-[#f0f4fa]">
                ...
                <Link href="/mot" onClick={() => setOpen(false)} className="flex items-center gap-3 px-4 py-3.5 transition hover:bg-[#f4f8ff]">
                  <span className="flex h-9 w-9 shrink-0 items-center justify-center rounded-xl bg-[#f4f8ff] text-[#0F63FF]">
                ...
                {/* EV Battery */}
                <Link href="/ev-battery" onClick={() => setOpen(false)} className="flex items-center gap-3 px-4 py-3.5 transition hover:bg-[#f4f8ff]">
                  <span className="flex h-9 w-9 shrink-0 items-center justify-center rounded-xl bg-[#f4f8ff] text-[#0F63FF]">
                  ...
                  <div className="flex-1 min-w-0">
                    <p className="text-sm font-semibold text-[#020F3D]">EV Battery Health</p>
                    <p className="text-xs text-slate-400">Diagnostics & range testing</p>
                  </div>
                  <svg className="h-4 w-4 shrink-0 text-slate-300" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}><path strokeLinecap="round" strokeLinejoin="round" d="M8.25 4.5l7.5 7.5-7.5 7.5"/></svg>
                </Link>
