  ...
  return (
    ...
    <header className="sticky top-0 z-50 bg-white/98 shadow-[0_6px_18px_rgba(2,15,61,0.05)] backdrop-blur">
      ...
      <>
        ...
        />
        <div
          className="fixed top-0 right-0 z-50 h-full w-4/5 max-w-xs bg-white lg:hidden overflow-y-auto shadow-2xl transition-transform duration-300 ease-in-out"
        ...
        >
            ...
            <div className="flex flex-col gap-2 px-3 pb-5 pt-2">
              <a href={`tel:${site.phoneTel}`}
                className="flex h-12 w-full items-center justify-center gap-2 rounded-xl bg-[#020F3D] px-4 text-sm font-semibold text-white transition hover:bg-[#061744]">
                <svg className="h-4 w-4 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M2.25 6.75c0 8.284 6.716 15 15 15h2.25a2.25 2.25 0 0 0 2.25-2.25v-1.372c0-.516-.351-.966-.852-1.091l-4.423-1.106c-.44-.11-.902.055-1.173.417l-.97 1.293c-.282.376-.769.542-1.21.38a12.035 12.035 0 0 1-7.143-7.143c-.162-.441.004-.928.38-1.21l1.293-.97c.363-.271.527-.734.417-1.173L6.963 3.102a1.125 1.125 0 0 0-1.091-.852H4.5A2.25 2.25 0 0 0 2.25 4.5v2.25Z"/></svg>
                <span className="truncate">Call {site.phoneDisplay}</span>
              </a>
              <a href={waUrl()} target="_blank" rel="noopener noreferrer"
                className="flex h-12 w-full items-center justify-center gap-2 rounded-xl bg-[#25D366] px-4 text-sm font-semibold text-white transition hover:bg-[#1ebe5d]">
              ...
              <Link href="/quote" onClick={closeMenu}
                className="flex h-12 w-full items-center justify-center gap-2 rounded-xl bg-[#0F63FF] px-4 text-sm font-semibold text-white transition hover:bg-[#1E6BFF]">
