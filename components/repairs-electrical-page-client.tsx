        ...
        <div className="mx-auto max-w-5xl">
          <div className="grid items-center gap-10 lg:grid-cols-2">
            <div>
              ...
              <h1 className="mt-2 text-3xl font-extrabold leading-tight text-[#020F3D] sm:text-5xl"><EditableText pageKey="repairs-electrical" fieldKey="hero_title" value={content.hero_title} type="text" editable={editable} /></h1>
              <p className="mt-4 text-base leading-relaxed text-slate-500 sm:text-lg"><EditableText pageKey="repairs-electrical" fieldKey="hero_subtitle" value={content.hero_subtitle} type="textarea" editable={editable} /></p>
