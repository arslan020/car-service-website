...
export function BrakeFluidPageClient({ content: c, editable = false }: { content: ContentMap; editable?: boolean }) {
  ...
  return (
    <div className="bg-white">
          ...
          <div className="grid items-center gap-10 lg:grid-cols-2">
            <div>
              <p className="text-xs font-bold uppercase tracking-widest text-[#0F63FF]">
                <EditableText pageKey="brake-fluid" fieldKey="hero_kicker" value={c.hero_kicker} editable={editable} />
              </p>
              <h1 className="mt-2 text-3xl font-extrabold leading-tight text-[#020F3D] sm:text-5xl">
                <EditableText pageKey="brake-fluid" fieldKey="hero_title" value={c.hero_title} editable={editable} />
              </h1>
              <p className="mt-4 text-base leading-relaxed text-slate-500 sm:text-lg">
                <EditableText pageKey="brake-fluid" fieldKey="hero_subtitle" value={c.hero_subtitle} type="textarea" editable={editable} />
              </p>
              <p className="mt-3 text-3xl font-extrabold text-[#0F63FF]">
                <EditableText pageKey="brake-fluid" fieldKey="price_display" value={c.price_display} editable={editable} />
              </p>
              <p className="mt-1 text-sm font-semibold text-slate-500">
                <EditableText pageKey="brake-fluid" fieldKey="price_note" value={c.price_note} editable={editable} />
              </p>
            ...
            <div className="grid grid-cols-2 gap-4">
              {stats.map((s) => (
                <div key={s.valueKey} className="rounded-2xl border border-[#e8effa] bg-white p-5 text-center shadow-sm">
                  <p className="text-2xl font-extrabold text-[#0F63FF]">
                    <EditableText pageKey="brake-fluid" fieldKey={s.valueKey} value={s.value} editable={editable} />
                  </p>
                  <p className="mt-1 text-xs text-slate-500">
                    <EditableText pageKey="brake-fluid" fieldKey={s.labelKey} value={s.label} editable={editable} />
                  </p>
                </div>
              ))}
            </div>
      ...
      <section className="px-4 py-12 sm:py-16">
        <div className="mx-auto max-w-5xl">
          <p className="text-xs font-bold uppercase tracking-widest text-[#0F63FF]">
            <EditableText pageKey="brake-fluid" fieldKey="includes_kicker" value={c.includes_kicker} editable={editable} />
          </p>
          <h2 className="mt-1 text-2xl font-extrabold text-[#020F3D] sm:text-3xl">
            <EditableText pageKey="brake-fluid" fieldKey="includes_title" value={c.includes_title} editable={editable} />
          </h2>
        ...
        <div className="mx-auto max-w-5xl">
          <div className="text-center">
            <p className="text-xs font-bold uppercase tracking-widest text-red-500">
              <EditableText pageKey="brake-fluid" fieldKey="signs_kicker" value={c.signs_kicker} editable={editable} />
            </p>
            <h2 className="mt-1 text-2xl font-extrabold text-[#020F3D] sm:text-3xl">
              <EditableText pageKey="brake-fluid" fieldKey="signs_title" value={c.signs_title} editable={editable} />
            </h2>
          </div>
              ...
              <div key={s.titleKey} className="flex flex-col gap-3 rounded-2xl border border-[#e0ebff] bg-white p-5 shadow-sm">
                <div className="flex items-center gap-3">
                  ...
                  <h3 className="font-bold text-[#020F3D]">
                    <EditableText pageKey="brake-fluid" fieldKey={s.titleKey} value={s.title} editable={editable} />
                  </h3>
                </div>
                <p className="text-sm leading-relaxed text-slate-500">
                  <EditableText pageKey="brake-fluid" fieldKey={s.bodyKey} value={s.body} type="textarea" editable={editable} />
                </p>
              </div>
            ))}
          </div>
      ...
      <section className="px-4 py-12 sm:py-16">
        <div className="mx-auto max-w-3xl">
          <div className="text-center">
            <p className="text-xs font-bold uppercase tracking-widest text-[#0F63FF]">
              <EditableText pageKey="brake-fluid" fieldKey="faq_kicker" value={c.faq_kicker} editable={editable} />
            </p>
            <h2 className="mt-1 text-2xl font-extrabold text-[#020F3D] sm:text-3xl">
              <EditableText pageKey="brake-fluid" fieldKey="faq_title" value={c.faq_title} editable={editable} />
            </h2>
          </div>
          <div className="mt-8 space-y-4">
            {faqs.map((faq) => (
              <div key={faq.qKey} className="rounded-2xl border border-[#e8effa] bg-white p-5 shadow-sm">
                <h3 className="font-bold text-[#020F3D]">
                  <EditableText pageKey="brake-fluid" fieldKey={faq.qKey} value={faq.q} editable={editable} />
                </h3>
                <p className="mt-2 text-sm leading-relaxed text-slate-500">
                  <EditableText pageKey="brake-fluid" fieldKey={faq.aKey} value={faq.a} type="textarea" editable={editable} />
                </p>
              </div>
            ))}
          </div>
        ...
        <div className="mx-auto max-w-5xl">
          <div className="overflow-hidden rounded-3xl bg-[#020F3D] px-8 py-10 text-center shadow-xl sm:py-14">
            <p className="text-xs font-bold uppercase tracking-widest text-[#4DA3FF]">
              <EditableText pageKey="brake-fluid" fieldKey="cta_kicker" value={c.cta_kicker} editable={editable} />
            </p>
            <h2 className="mt-2 text-2xl font-extrabold text-white sm:text-3xl">
              <EditableText pageKey="brake-fluid" fieldKey="cta_title" value={c.cta_title} editable={editable} />
            </h2>
            <p className="mx-auto mt-3 max-w-md text-sm leading-relaxed text-slate-300">
              {site.addressLines.join(", ")} <EditableText pageKey="brake-fluid" fieldKey="cta_note" value={c.cta_note} editable={editable} />.
            </p>
