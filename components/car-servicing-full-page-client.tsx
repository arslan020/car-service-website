        ...
        <div className="mx-auto max-w-5xl">
          <div className="grid items-center gap-10 lg:grid-cols-2">
            <div>
              ...
              <h1 className="mt-2 text-3xl font-extrabold leading-tight text-[#020F3D] sm:text-5xl"><EditableText pageKey="car-servicing-full" fieldKey="hero_title" value={content.hero_title} type="text" editable={editable} /></h1>
              <p className="mt-4 text-base leading-relaxed text-slate-500 sm:text-lg"><EditableText pageKey="car-servicing-full" fieldKey="hero_subtitle" value={content.hero_subtitle} type="textarea" editable={editable} /></p>
          ...
          <div className="mt-8 space-y-4">
            {FAQ_KEYS.map((faq) => (
              <div key={faq.qKey} className="rounded-2xl border border-[#e8effa] bg-white p-5 shadow-sm">
                <h3 className="font-bold text-[#020F3D]"><EditableText pageKey="car-servicing-full" fieldKey={faq.qKey} value={content[faq.qKey]} type="text" editable={editable} /></h3>
                <p className="mt-2 text-sm leading-relaxed text-slate-500"><EditableText pageKey="car-servicing-full" fieldKey={faq.aKey} value={content[faq.aKey]} type="textarea" editable={editable} /></p>
              </div>
            ))}
          </div>
        </div>
