    ...
    <div className="bg-white">
      ...
      <section className="px-4 py-12 sm:py-16">
        <div className="mx-auto max-w-5xl">
          <p className="text-xs font-bold uppercase tracking-widest text-[#0F63FF]">{c.cats_kicker}</p>
          <h2 className="mt-1 text-2xl font-extrabold text-[#020F3D] sm:text-3xl">{c.cats_title}</h2>
                ...
                <Link key={cat.href} href={cat.href} className="group flex flex-col rounded-2xl border border-[#e8effa] bg-white p-6 shadow-sm transition-all hover:-translate-y-0.5 hover:border-[#0F63FF]/30 hover:shadow-[0_6px_24px_rgba(15,99,255,0.1)]">
                  <div className="flex flex-col gap-3">
                    <div className="flex items-center gap-3">
                      ...
                      <h3 className="font-bold text-[#020F3D] transition-colors group-hover:text-[#0F63FF]">{title}</h3>
                    </div>
