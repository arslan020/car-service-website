  ...
  return (
    <div className="bg-white">
      ...
      <section className="px-4 py-12 sm:py-16">
        <div className="mx-auto max-w-5xl">
          <p className="text-xs font-bold uppercase tracking-widest text-[#0F63FF]">{c.cover_kicker}</p>
          <h2 className="mt-1 text-2xl font-extrabold text-[#020F3D] sm:text-3xl">{c.cover_title}</h2>
      ...
      <section className="bg-[#f4f8ff] px-4 py-10 sm:py-16">
        <div className="mx-auto max-w-5xl">
          <div className="text-center">
            ...
            <h2 className="mt-1 text-2xl font-extrabold text-[#020F3D] sm:text-3xl">{c.signs_title}</h2>
          </div>
