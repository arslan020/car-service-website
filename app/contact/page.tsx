    ...
    <div className="bg-white">
      ...
      <section className="px-4 py-12 sm:py-16">
        <div className="mx-auto max-w-5xl">
          ...
          {/* Section heading — above both columns */}
          <div className="mb-8">
          ...
          <div className="grid gap-6 lg:grid-cols-2">
            ...
            {/* Left col — 2x2 contact cards */}
            <div className="grid grid-cols-2 gap-3 content-start">
              {/* Phone */}
              <a
                href={`tel:${site.phoneTel}`}
                className="group flex flex-col gap-3 rounded-2xl border border-[#e8effa] bg-white p-4 shadow-sm transition-all hover:-translate-y-0.5 hover:border-[#3f63ff]/30 hover:shadow-[0_6px_24px_rgba(63,99,255,0.1)]"
              >
                <span className="flex h-10 w-10 items-center justify-center rounded-xl bg-[#eef4ff] text-[#3f63ff] transition-all group-hover:bg-[#3f63ff] group-hover:text-white">
                ...
                <div>
                  ...
                  <p className="mt-0.5 text-sm font-bold text-[#101a56] group-hover:text-[#3f63ff]">{site.phoneDisplay}</p>
                </div>
              </a>
              ...
              <a
                ...
                className="group flex flex-col gap-3 rounded-2xl border border-[#e8effa] bg-white p-4 shadow-sm transition-all hover:-translate-y-0.5 hover:border-[#25D366]/40 hover:shadow-[0_6px_24px_rgba(37,211,102,0.1)]"
              >
                <span className="flex h-10 w-10 items-center justify-center rounded-xl bg-[#eef4ff] text-[#3f63ff] transition-all group-hover:bg-[#25D366] group-hover:text-white">
                ...
                <div>
                  ...
                  <p className="mt-0.5 text-sm font-bold text-[#101a56]">+44 7487 694578</p>
                </div>
              </a>
              ...
              >
                ...
                <div>
                  ...
                  <p className="mt-0.5 text-sm font-bold text-[#101a56] group-hover:text-[#3f63ff] break-all">{site.email}</p>
                </div>
              </a>
              ...
              >
                ...
                <div>
                  ...
                  <p className="mt-0.5 text-sm font-bold text-[#101a56] group-hover:text-[#3f63ff]">235 Yeading Ln, Hayes, UB4 9AD</p>
                </div>
              </a>
            </div>
