        ...
        <div className="mx-auto max-w-5xl">
          ...
          <div className="mt-6 grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
            {SERVICES.map((svc) => (
              ...
              >
                <span className="flex flex-1 items-center gap-3 sm:flex-col sm:items-start sm:gap-0">
        ...
        <div className="mx-auto max-w-5xl">
          ...
          <div className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            {HOW_IT_WORKS.map((step) => (
              <div
                key={step.n}
                className="flex items-center gap-3 rounded-2xl border border-[#e0ebff] bg-white p-5 shadow-sm sm:flex-col sm:items-start sm:gap-0"
              >
