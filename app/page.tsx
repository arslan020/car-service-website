      ...
      <section className="py-12 sm:py-16">
        <div className="mx-auto max-w-full">
          ...
          <div className="px-6 pb-8 text-center sm:px-12">
            <h2 className="text-3xl font-extrabold text-[#101a56]">Get in touch</h2>
            <p className="mt-2 text-sm text-slate-500">Call us, WhatsApp, or book online — we&apos;re here to help.</p>

            {/* Open status */}
            {isOpen !== null && (
              <div className="mt-4 inline-flex items-center gap-2 rounded-full border border-[#e0ebff] bg-[#f4f8ff] px-4 py-1.5">
            ...
            <div className="mt-5 flex flex-col items-center gap-3 sm:flex-row sm:justify-center">
              <a
                ...
                className="flex w-full items-center justify-center gap-2.5 rounded-xl bg-[#101a56] px-8 py-3.5 text-sm font-bold text-white shadow-md transition hover:bg-[#16236e] sm:w-auto"
              >
              ...
              <a
                ...
                className="flex w-full items-center justify-center gap-2.5 rounded-xl bg-[#25D366] px-8 py-3.5 text-sm font-bold text-white shadow-md transition hover:bg-[#1ebe5d] sm:w-auto"
              >
