...
const VALUES = [
  {
    ...
    body: "No hidden charges. We explain every job in plain English and give you a clear quote before any work starts.",
  },
  {
    icon: (
      <svg className="h-6 w-6" fill="none" stroke="currentColor" strokeWidth={1.75} viewBox="0 0 24 24">
    ...
    body: "Our technicians are fully trained and experienced across all makes and models, from city cars to light vans.",
  },
  {
    icon: (
      <svg className="h-6 w-6" fill="none" stroke="currentColor" strokeWidth={1.75} viewBox="0 0 24 24">
    ...
    body: "Most services and MOTs are completed same day. We respect your time and always aim to get you back on the road quickly.",
  },
  {
    icon: (
      <svg className="h-6 w-6" fill="none" stroke="currentColor" strokeWidth={1.75} viewBox="0 0 24 24">
  ...
  },
  {
    ...
    title: "5-Star Rated",
    body: "Hundreds of 5-star reviews from drivers across Hayes, Southall, Uxbridge and the wider West London area.",
  },
  {
    icon: (
      <svg className="h-6 w-6" fill="none" stroke="currentColor" strokeWidth={1.75} viewBox="0 0 24 24">
    ...
    title: "DVSA Approved",
    body: "Officially approved MOT testing station. Every MOT is carried out to strict DVSA standards by authorised testers.",
  },
];
    ...
    <>
      ...
      <div className="bg-white">
        ...
        <section className="bg-gradient-to-b from-[#eefdff] via-[#f5feff] via-60% to-white px-4 pb-12 pt-16 sm:pt-20">
          <div className="mx-auto max-w-5xl">
            <div className="grid items-center gap-10 lg:grid-cols-2">
              <div>
                <p className="text-xs font-bold uppercase tracking-widest text-[#0F63FF]">About Us</p>
        ...
        <section className="px-4 py-12 sm:py-16">
          <div className="mx-auto max-w-5xl">
            <div className="grid gap-10 lg:grid-cols-2 lg:items-center">
              <div>
                <p className="text-xs font-bold uppercase tracking-widest text-[#0F63FF]">Our Story</p>
                <h2 className="mt-1 text-2xl font-extrabold text-[#020F3D] sm:text-3xl">
                  A Garage Built on Trust
                </h2>
        ...
        <section className="bg-[#f4f8ff] px-4 py-12 sm:py-16">
          <div className="mx-auto max-w-5xl">
            <div className="text-center">
              <p className="text-xs font-bold uppercase tracking-widest text-[#0F63FF]">Why Choose Us</p>
              <h2 className="mt-1 text-2xl font-extrabold text-[#020F3D] sm:text-3xl">
                What Sets Us Apart
              </h2>
            </div>
            <div className="mt-10 grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
              {VALUES.map((v) => (
                <div key={v.title} className="flex flex-col gap-3 rounded-2xl border border-[#e0ebff] bg-white p-6 shadow-sm">
                  <span className="flex h-11 w-11 items-center justify-center rounded-xl bg-[#eef4ff] text-[#0F63FF]">
                    {v.icon}
                  </span>
                  <h3 className="font-bold text-[#020F3D]">{v.title}</h3>
        ...
        <section className="px-4 py-12 sm:py-16">
          <div className="mx-auto max-w-5xl">
            <div className="text-center">
              <p className="text-xs font-bold uppercase tracking-widest text-[#0F63FF]">What We Do</p>
              <h2 className="mt-1 text-2xl font-extrabold text-[#020F3D] sm:text-3xl">Our Services</h2>
              <p className="mx-auto mt-3 max-w-lg text-sm leading-relaxed text-slate-500">
                From a quick MOT to a full major service, we cover everything your car needs under one roof.
              </p>
            </div>
