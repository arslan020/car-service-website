...
const FAQS = [
  {
    ...
    a: "Most manufacturers recommend every 2 years, regardless of mileage. Brake fluid is hygroscopic â€” it absorbs moisture from the air over time, which lowers its boiling point and can affect braking performance.",
  },
  {
    q: "Why does brake fluid need replacing if it isn't leaking?",
    a: "Moisture absorption happens gradually through seals and hoses, not just from leaks. Contaminated fluid can boil under hard braking, causing a spongy pedal or reduced stopping power â€” known as brake fade.",
  },
  {
    q: "Is this the same as a brake pad or disc replacement?",
    a: "No â€” this is a separate service covering just the hydraulic brake fluid. If we spot worn pads, discs, or callipers during the check, we'll quote separately before doing any extra work.",
  },
  {
      ...
      <section className="px-4 py-12 sm:py-16">
        <div className="mx-auto max-w-5xl">
          <div className="overflow-hidden rounded-3xl bg-[#020F3D] px-8 py-10 text-center shadow-xl sm:py-14">
            ...
            <p className="mx-auto mt-3 max-w-md text-sm leading-relaxed text-slate-300">{site.addressLines.join(", ")} â€” walk-ins welcome.</p>
