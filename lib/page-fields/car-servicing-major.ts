...
export const CAR_SERVICING_MAJOR_FIELDS: FieldDef[] = [
  ...
  A("hero_subtitle", "Subtitle", "The most comprehensive service — everything in a Full Service plus spark plugs, coolant change, a multi-point check, and a full road test.", "Hero"),
  ...
  // Stats
  T("stat_1_value", "Stat 1 — value", "~3–4 hrs", "Stats"),
  ...
  A("faq_1_a", "FAQ 1 — Answer", "A Major Service is the most comprehensive annual service, following your car's manufacturer schedule. It includes everything in a Full Service plus spark plugs, coolant change, a comprehensive multi-point check, and a full road test — typically due every 2 years or 24,000 miles.", "FAQs"),
  T("faq_2_q", "FAQ 2 — Question", "How is it different from a Full Service?", "FAQs"),
  A("faq_2_a", "FAQ 2 — Answer", "A Full Service covers the standard 12-month checks. A Major Service adds component replacements that are due on a longer cycle — spark plugs, fluids that degrade over time, and a manufacturer-schedule compliance check.", "FAQs"),
  ...
  A("faq_4_a", "FAQ 4 — Answer", "Typically 3–4 hours depending on the vehicle. We will always confirm timing when you book and text you when the car is ready.", "FAQs"),
