...
const HOME_FIELDS: FieldDef[] = [
  ...
  T("svc_1_price", "Featured 1, price display", "£54.85", "Our services"),
...
Advice on fuel system health if we spot anything`,
  ...
  },
  {
    ...
    fields: [
      ...
      {
        key: "hero_price",
        label: "Price Badge (e.g. \"From £54.85\")",
        type: "text",
        default: "From £54.85",
        section: "Hero",
      },
      ...
      },
      {
        ...
        type: "textarea",
        default:
          "Our MOT is a fixed £54.85, no hidden extras, no surprises.",
        section: "FAQs",
      },
      {
        key: "faq_2_q",
      ...
      },
      {
        ...
        type: "textarea",
        default:
          "Yes. Book an MOT alongside any service and £14.85 is taken off, plus it means only one drop-off. Select a package when you book online.",
        section: "FAQs",
      },
      {
        key: "faq_4_q",
...
Written report on brake system condition`,
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "faq_3_a", label: "FAQ 3, Answer", type: "textarea", default: "Yes! We highly recommend it, book an MOT with any service and £14.85 is taken off, plus it saves you time. Just choose the MOT + Service package in our online booking flow.", section: "FAQs" },
